        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="https://github.com/nextlevelbuilder/ui-ux-pro-max-skill" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-white mb-4">{t('resources')}</h3>
            <ul className="space-y-3">
              ...
              <li><Link href="#stacks" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Tech Stacks</Link></li>
              <li><Link href="#styles" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Style Gallery</Link></li>
            </ul>
          </div>
          
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-white mb-4">{t('database')}</h3>
            <ul className="space-y-3">
